...
const HeroSection = () => {
    ...
    useEffect(() => {
        ...
        gsap.fromTo(".gsap-buttons", {
            x: '100%',
            opacity:0,
            duration:4
        }, {x: '0%', opacity: 1, duration: 3})
        gsap.fromTo(".gsap-icons", {
            opacity:0,
            duration:4,
            y: '100%',
    ...
    return (
        ...
        <section className='overflow-hidden'>
            <div className='grid grid-cols-1 sm:grid-cols-12'>
                <div className='col-span-7 place-self-center text-center sm:text-left mt-14'>
                    ...
                    <div className='relative gsap-buttons'>
                    ...
                    <div className="mt-8 justify-center items-center gsap-icons">
                            <button className="text-2xl ml-4 text-white"> {/* Clase de Tailwind para tamaño de texto extra grande */}
                                <BsGithub className="w-8 h-8" /> {/* Clases de Tailwind para ancho y alto */}
                            </button>
                            <button className="text-2xl ml-4 text-white"> {/* Clat-whitese de Tailwind para tamaño de texto extra grande */}
                                <DiJsBadge className="w-8 h-8" /> {/* Clases de Tailwind para ancho y alto */}
                            </button>
                            <button className="text-2xl ml-4 text-white"> {/* Clase de Tailwind para tamaño de texto extra grande */}
                                <DiReact className="w-8 h-8" /> {/* Clases de Tailwind para ancho y alto */}
                            </button>
                    </div>
                </div>
